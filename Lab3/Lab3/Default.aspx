...
<%@ Register TagPrefix="chn" TagName="CustomControl" Src="./WebUserControl.ascx" %>
...
<h3>Part 1</h3>
    ...
    <div class="jumbotron">
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                ...
                <asp:Button ID="Button5" runat="server" Text="Get time" OnClick="Button1_OnClick"/>
            </ContentTemplate>
        </asp:UpdatePanel>
        ...
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            <ContentTemplate>
                ...
                <asp:Button ID="Button6" runat="server" Text="Button" OnClick="Button2_OnClick" />
            </ContentTemplate>
        </asp:UpdatePanel>
    ...
    <div class="jumbotron">
        <chn:CustomControl runat="server"
                           Surname="Матюх"
                           Name="Арсений"
